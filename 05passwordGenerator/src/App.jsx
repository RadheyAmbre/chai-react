    ...
    <>
      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg py-4 px-4 my-8 text-orange-500 bg-gray-700">
        <div className="flex shadow-md rounded-lg mb-4">
          ...
          <button onClick={copyPasswordToClipboard} className="outline-none bg-blue-700 hover:bg-blue-500 text-white font-bold py-2 px-4 shrink-0 rounded">Copy</button>
        </div>
